...
#if VSMC_STDTBB_USE_THREAD
#ifndef VSMC_STDTBB_USE_FUTURE
#define VSMC_STDTBB_USE_FUTURE 0
#endif
#endif

#if !defined(VSMC_STDTBB_USE_FUTURE) && !defined(VSMC_STDTBB_USE_THREAD)
#if VSMC_HAS_CXX11LIB_FUTURE
#define VSMC_STDTBB_USE_FUTURE 1
#define VSMC_STDTBB_USE_THREAD 0
#else
#define VSMC_STDTBB_USE_FUTURE 0
#define VSMC_STDTBB_USE_THREAD 1
#endif
#endif
