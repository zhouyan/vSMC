#ifndef VSMC_RANDOM_WALK_LOG_NORMAL_HPP
#define VSMC_RANDOM_WALK_LOG_NORMAL_HPP
...
/// \ingroup RandomWalk
class LogNormalRandomWalk : public BaseRandomWalk
{
    public :

    LogNormalRandomWalk () : rnorm_(0, 1) {}
...
#endif // VSMC_RandomWalk_LOG_NORMAL_HPP
