...
/// \ingroup RDRNG
template <std::size_t NTrialMax> struct RdSeedStep<uint16_t, NTrialMax>
{
...
/// \ingroup RDRNG
template <std::size_t NTrialMax> struct RdSeedStep<uint32_t, NTrialMax>
{
...
/// \ingroup RDRNG
template <std::size_t NTrialMax> struct RdSeedStep<uint64_t, NTrialMax>
{
