...
IF (NOT VSMC_RANDOM_FOUND)
    ...
    IF (RANDOM123_FOUND)
        SET (VSMC_R123_FLAG -DVSMC_USE_RANDOM123=1)
    ELSE (RANDOM123_FOUND)
        SET (VSMC_R123_FLAG -DVSMC_USE_RANDOM123=0)
    ...
    ENDIF (RANDOM123_FOUND)
    SET (CMAKE_REQUIRED_DEFINITIONS ${VSMC_R123_FLAG}
        -DVSMC_HAS_CXX11LIB_RANDOM=1)
    CHECK_CXX_SOURCE_RUNS ("${VSMC_RANDOM_TEST_SOURCE}" VSMC_RANDOM_STD_FOUND)
    IF (Boost_FOUND)
        SET (CMAKE_REQUIRED_DEFINITIONS ${VSMC_R123_FLAG}
