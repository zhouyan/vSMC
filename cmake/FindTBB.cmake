...
IF (NOT TBB_LIB_PATH)
    ...
    ELSE (MSVC)
        ...
        ELSE (TBB_ROOT)
            ...
            SET (TBB_LIB_PATH ${TBB_LIB_PATH} /opt/intel/tbb/lib/intel64/gcc4.4)
            SET (TBB_LIB_PATH ${TBB_LIB_PATH} /opt/intel/tbb/lib/intel64/gcc4.1)
            SET (TBB_LIB_PATH ${TBB_LIB_PATH} /opt/intel/tbb/lib/ia32)
            SET (TBB_LIB_PATH ${TBB_LIB_PATH} /opt/intel/tbb/lib/ia32/gcc4.4)
            SET (TBB_LIB_PATH ${TBB_LIB_PATH} /opt/intel/tbb/lib/ia32/gcc4.1)
        ENDIF (TBB_ROOT)
    ENDIF (MSVC)
...
FILE (READ ${PROJECT_SOURCE_DIR}/cmake/FindTBB.cpp TBB_TEST_SOURCE)
...
IF (NOT DEFINED TBB_FOUND)
    IF (TBB_BASIC_FOUND)
        ...
        ELSE (MSVC)
            ...
            FOREACH (EXCEPTION_FLAG 0 1)
                FOREACH (CPP0X_FLAG 0 1)
