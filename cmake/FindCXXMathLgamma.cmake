...
IF (NOT DEFINED CXX_MATH_LGAMMA_FOUND)
    ...
    IF (NOT CXX_MATH_LGAMMA_C99_FOUND)
        CHECK_CXX_SOURCE_RUNS ("${CXX_MATH_LGAMMA_TEST_SOURCE}"
            CXX_MATH_LGAMMA_STD_FOUND)
    ENDIF (NOT CXX_MATH_LGAMMA_C99_FOUND)
    IF (Boost_FOUND)
        IF (NOT CXX_MATH_LGAMMA_C99_FOUND AND NOT CXX_MATH_LGAMMA_STD_FOUND)
            CHECK_CXX_SOURCE_RUNS ("${CXX_MATH_LGAMMA_TEST_SOURCE}"
                CXX_MATH_LGAMMA_BOOST_FOUND)
        ENDIF (NOT CXX_MATH_LGAMMA_C99_FOUND AND NOT CXX_MATH_LGAMMA_STD_FOUND)
    ENDIF (Boost_FOUND)
