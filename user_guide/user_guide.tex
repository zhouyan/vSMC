...
\author{Yan Zhou}
\date{Second edition (version develop)\vskip1ex\today}
...
\def\cpusse{\os: CentOS 7.2; \cpu: Intel Xeon W3550 @ 3.07GHz (Nehalem, \sse2)}
\def\cpuavx{\os: CentOS 7.2; \cpu: Intel Core i7 4960\textsc{hp} @ 2.60GHz
  (Haswell, \avx2)}
