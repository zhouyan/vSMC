...
total numbers of cycles of the 100 simulations are recorded, and then divided
by the to the total number of bytes generated. This give the performance
measurement in cpB. This experiment is repeated ten times, and the best results
is shown in tables later. The two performance data are labeled ``Loop'' and
``\verb|rng_rand|'', respectively.
...
data are labeled ``\std/Boost'', ``\vsmc'', ``\verb|rng_rand|'' and ``\mkl'',
respectively.
