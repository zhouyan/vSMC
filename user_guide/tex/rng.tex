...
\verb|rng_rand|, which provides vectorized random number generating. There are
two versions. The first operates on \rng engines and generates random integers,
\begin{Verbatim}
...
The second version of \verb|rng_rand| is for generating distribution random
numbers,
\begin{Verbatim}
...
are labeled ``Loop'' and ``\verb|rng_rand|'', respectively.
...
``\verb|rng_rand|'' and ``\mkl'', respectively.
